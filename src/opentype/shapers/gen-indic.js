...
const stateMachineJsonBytes = Buffer.from(JSON.stringify(stateMachine));
const jsonBase64DeflatedIndic = JSON.stringify(zlib.deflateSync(stateMachineJsonBytes).toString('base64'));
